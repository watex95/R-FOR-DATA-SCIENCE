---
title: Predict the number of applications received using the other variables in the
  College data set in library ISLR
author: "student"
date: "1/30/2020"
...
This displays the metrics in the model including: ncom (number of predictors which is the value of M), root mean squared error, R-squared, mean absolute error etc.
```{r}
mod1$results
```
